        ...
        <div class="page">
            <H2>Управление заявкой</H2>
                <fieldset>
                    ...
                    <p><input name="remove" type="submit" value="Удалить заявку"></p>
                </form>
                <form  action="createtour.php?orderid=<?echo $order_id?>" method="post" name="createtourform">
                    <p><input name="createtour" type="submit" value="Создать тур"></p>
                </form>
            </fieldset>
        </div>
        <footer>
